  ...
  public void runOpMode() {
    ...
    if (opModeIsActive()) {
      ...
      while (opModeIsActive()) {
        ...
        left4Bar.setPower(gamepad1.right_stick_y); //attempt to move 4bar up/down with the joystick (NOT WORKING YET)
        right4Bar.setPower(gamepad1.right_stick_y);
        
        clawServo.setPosition(clawServo.getPosition() + gamepad1.right_stick_x);
        
        telemetry.addData("Claw Servo Position", clawServo.getPosition());
        telemetry.addData("Left 4Bar Position", left_4Bar.getPosition());
        telemetry.addData("Right 4Bar Position", right_4Bar.getPosition());
